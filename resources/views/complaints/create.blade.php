<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">📝 Submit a Complaint</h2>
    </x-slot>
                ...
                <form method="POST" action="{{ route('complaints.store') }}" class="space-y-5">
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="5" required
                                  class="w-full px-4 py-2 rounded-lg bg-white/20 border border-white/30 text-white placeholder-white/50">{{ old('description') }}</textarea>
                    </div>
