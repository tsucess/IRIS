<x-app-layout>
    ...
    <div class="min-h-screen bg-gradient-to-br from-blue-900/60 via-indigo-900/40 to-purple-800/60 p-6">
        <x-glass-form method="POST" action="{{ route('announcements.store') }}">
            @csrf
            ...
            <div class="mb-3">
                ...
                <x-text-input id="title" name="title" type="text"
                    ...
                    value="{{ old('title') }}" required placeholder="Announcement title" />
            ...
            <div class="mb-3">
                ...
                <select id="audience" name="audience" required
                    ...
                    <option value="all"       @selected(old('audience','all')==='all')>🌍 Everyone (public)</option>
            ...
            <div class="mb-3">
                ...
                <textarea id="body" name="body" rows="8" required
                          ...
                          placeholder="Write your announcement content here…">{{ old('body') }}</textarea>
            ...
            <div class="flex items-center gap-4">
                <x-primary-button class="bg-blue-600 hover:bg-blue-700">💾 Post Announcement</x-primary-button>
                <a href="{{ route('announcements.manage') }}"
