<x-app-layout>
    ...
    <main class="bg-[#181818] gap-1 flex flex-row items-center justify-center font-segoe leading-normal"
        style="height: 92vh">
        <!-- ID CARD -->
        {{-- <div --}}
        ...
        <div
            class=" flex flex-col gap-[10px] z-20 relative w-[500px] h-[300px] p-[15px] rounded-[10px] overflow-hidden bg-gradient-to-b from-[#ffffff] to-[#0077b6] group">
            <!-- TOP PART -->
        ...
        {{-- BACK VIEW  --}}
        <div {{-- class="flex flex-col gap-[10px] z-20 relative w-[500px] h-[300px] p-[15px] rounded-[10px] overflow-hidden bg-gradient-to-b from-[#7f6065] to-[#638e8d] group"> --}}
            class="relative flex flex-col gap-[10px] z-20 relative w-[500px] h-[300px] p-[15px] rounded-[10px] overflow-hidden bg-gradient-to-b from-[#ffffff] to-[#0077b6] group">
            <!-- TOP PART -->
