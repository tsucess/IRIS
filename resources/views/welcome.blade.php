...
<body class="relative z-10 flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
   ...
   <div id="page-loader" class="page-loader">
    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                class="text-[13px] leading-[20px] flex-1 p-6 pb-12 lg:p-20 bg-white/90 dark:bg-[#161615]/90  dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none">
                <h1 class="mb-2 font-black text-xl">WELCOME TO ILISAN COMMUNITY DEVELOPMENT SYSTEM</h1>
                <br>
                <p class="mb-2 text-[#706f6c] text-sm dark:text-[#A1A09A]" id="typewriter">Ilisan Remo
                    <b>(AGAKANOWO)</b> is a town in
                    Remo land, Ogun State, Nigeria, known for its peaceful environment and friendly people. It's
                    historically significant as one of the first towns to emerge from a migration from Iremo quarter in
                    Ile-Ife between 1400 and 1438 AD
                </p>
    ...
    <script>
        const words = [
            `Ilisan Remo (AGAKANOWO) is a town in Remo land, Ogun State, Nigeria, known for its peaceful environment and friendly people..`,
            `It's historically significant as one of the first towns to emerge from a migration from Iremo quarter in Ile-Ife between 1400 and 1438 AD `
        ];
        let i = 0;
        let j = 0;
        let currentWord = "";
