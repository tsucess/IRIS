<x-app-layout>
    <link rel="stylesheet" href="{{asset('/css/main-id.css')}}">
    <div class="bg-[#181818] gap-1 flex flex-row items-center justify-center font-segoe leading-normal"
        style="height: 92vh">
        <!-- ID CARD -->
        {{-- <div --}}
